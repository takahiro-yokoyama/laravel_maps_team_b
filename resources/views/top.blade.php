...
<section class="content">
    <div id="search">
        <div class="search_key">
            <h2>アニメから検索</h2>
            <form method="get" action="{{ url('/maps/anime') }}" class="search_form"">
                @csrf
        ...
        <div class="search_key">
            ...
            <form method="POST" action="" class="search_form">
                <select name="prefecture_name" class="search_area_select">
            ...
            地名ワード検索
            <form method="POST" action="" class="search_area_text">
                <input type="text" name="area" placeholder="新宿">
                <input type="submit" name="submit" value="検索">
            </form>
        </div>
        <div>
